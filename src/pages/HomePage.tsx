...
import saarthiLogo from "@/assets/careersetu-logo.jpg";
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-4rem)] gap-12 lg:gap-20 px-8 lg:pl-16">
            ...
            <div className="flex-1 text-left space-y-6 max-w-2xl">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground glow-text leading-relaxed">
                Find the right internship with AI-powered personalized
                recommendations
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <p className="text-white">
                  📧 Email:{" "}
                  <span className="text-primary">support@careersetu.in</span>
                </p>
                <p className="text-muted-foreground">
                  📞 Helpline:{" "}
                  <span className="text-primary">+91-9999999999</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start md:items-end space-y-4">
              ...
              <Button className="flex items-center space-x-2 bg-primary text-white hover:bg-primary/80 transition-smooth rounded-xl px-6 py-3 shadow">
